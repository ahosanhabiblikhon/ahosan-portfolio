          ...
          >
            <div className="glass-dark rounded-2xl p-8">
              ...
              <div className="space-y-4 text-gray-700 dark:text-gray-300">
                <p>
                  Hello! I&apos;m Ahosan Habib Likhon, a passionate Biotechnology
                  and Genetic Engineering student at Islamic University in
                  Kushtia, Bangladesh. My journey is driven by an insatiable
                  curiosity about the intricate mechanisms of life and the power
                  of technology to unlock its secrets.
                </p>

                <p>
                  While my academic foundation lies in the biological sciences,
                  I&apos;ve discovered a parallel passion for web development. I
                  believe that the intersection of biotechnology and technology
                  holds immense potential for innovation, and I&apos;m excited to
                  contribute to this emerging field.
                </p>

                <p>
                  Beyond the lab and the screen, I find joy in capturing the
                  world through my camera lens. Photography allows me to observe
                  nature&apos;s beauty with the same attention to detail I apply
                  to my scientific pursuits, creating a perfect balance in my
                  creative and analytical life.
                </p>
              </div>
            </div>
